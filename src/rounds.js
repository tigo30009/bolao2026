...
export const ROUNDS = [
  {
    ...
    matches: [
      ...
      // Grupo F
      { id: "m10", home: "Países Baixos",  away: "Japão",           date: "14/06", time: "17h",    city: "Dallas",           group: "F", kickoff: "2026-06-14T17:00", result: { home: 2, away: 2 } },
      // Grupo E
      { id: "m11", home: "Costa do Marfim",away: "Equador",         date: "14/06", time: "20h",    city: "Filadélfia",       group: "E", kickoff: "2026-06-14T20:00", result: { home: 1, away: 1 } },
      // Grupo F
      { id: "m12", home: "Suécia",         away: "Tunísia",         date: "14/06", time: "23h",    city: "Monterrey",        group: "F", kickoff: "2026-06-14T23:00", result: { home: 3, away: 0 } },
      // Grupo H
      { id: "m13", home: "Espanha",        away: "Cabo Verde",      date: "15/06", time: "13h",    city: "Atlanta",          group: "H", kickoff: "2026-06-15T13:00", result: { home: 3, away: 0 } },
      // Grupo G
      { id: "m14", home: "Bélgica",        away: "Egito",           date: "15/06", time: "16h",    city: "Seattle",          group: "G", kickoff: "2026-06-15T16:00", result: { home: 1, away: 0 } },
      // Grupo H
      { id: "m15", home: "Arábia Saudita", away: "Uruguai",         date: "15/06", time: "19h",    city: "Miami",            group: "H", kickoff: "2026-06-15T19:00", result: { home: 0, away: 2 } },
      // Grupo G
      { id: "m16", home: "Irã",            away: "Nova Zelândia",   date: "15/06", time: "22h",    city: "Los Angeles",      group: "G", kickoff: "2026-06-15T22:00", result: { home: 2, away: 0 } },
      // Grupo I
      ...
      // Grupo L
      { id: "m22", home: "Inglaterra",     away: "Croácia",         date: "17/06", time: "17h",    city: "Dallas",           group: "L", kickoff: "2026-06-17T17:00", result: { home: 1, away: 0 } },
      { id: "m23", home: "Gana",           away: "Panamá",          date: "17/06", time: "20h",    city: "Toronto",          group: "L", kickoff: "2026-06-17T20:00", result: { home: 2, away: 1 } },
      // Grupo K
      { id: "m24", home: "Uzbequistão",    away: "Colômbia",        date: "17/06", time: "23h",    city: "Cidade do México", group: "K", kickoff: "2026-06-17T23:00", result: { home: 0, away: 1 } },
    ],
  },
  {
    id: 2,
    ...
    matches: [
      ...
      // Grupo B
      { id: "m26", home: "Suíça",          away: "Bósnia",          date: "18/06", time: "16h",    city: "Los Angeles",      group: "B", kickoff: "2026-06-18T16:00", result: { home: 4, away: 1 } },
      { id: "m27", home: "Canadá",         away: "Qatar",           date: "18/06", time: "19h",    city: "Vancouver",        group: "B", kickoff: "2026-06-18T19:00", result: { home: 6, away: 0 } },
      // Grupo A
      { id: "m28", home: "México",         away: "Coreia do Sul",   date: "18/06", time: "22h",    city: "Guadalajara",      group: "A", kickoff: "2026-06-18T22:00", result: { home: 1, away: 0 } },
      // Grupo D
      { id: "m29", home: "EUA",            away: "Austrália",       date: "19/06", time: "16h",    city: "Seattle",          group: "D", kickoff: "2026-06-19T16:00", result: { home: 2, away: 0 } },
      // Grupo C
      { id: "m30", home: "Escócia",        away: "Marrocos",        date: "19/06", time: "19h",    city: "Boston",           group: "C", kickoff: "2026-06-19T19:00", result: { home: 0, away: 1 } },
      { id: "m31", home: "Brasil",         away: "Haiti",           date: "19/06", time: "21h30",  city: "Filadélfia",       group: "C", kickoff: "2026-06-19T21:30", result: { home: 3, away: 0 } },
      // Grupo D
      ...
      // Grupo F
      { id: "m33", home: "Países Baixos",  away: "Suécia",          date: "20/06", time: "14h",    city: "Houston",          group: "F", kickoff: "2026-06-20T14:00", result: { home: 5, away: 1 } },
      // Grupo E
      { id: "m34", home: "Alemanha",       away: "Costa do Marfim", date: "20/06", time: "17h",    city: "Toronto",          group: "E", kickoff: "2026-06-20T17:00", result: { home: 2, away: 1 } },
      { id: "m35", home: "Equador",        away: "Curaçao",         date: "20/06", time: "21h",    city: "Kansas City",      group: "E", kickoff: "2026-06-20T21:00", result: { home: 0, away: 0 } },
      // Grupo F
      { id: "m36", home: "Tunísia",        away: "Japão",           date: "21/06", time: "01h",    city: "Monterrey",        group: "F", kickoff: "2026-06-21T01:00", result: { home: 0, away: 4 } },
      // Grupo H
      { id: "m37", home: "Espanha",        away: "Arábia Saudita",  date: "21/06", time: "13h",    city: "Atlanta",          group: "H", kickoff: "2026-06-21T13:00", result: { home: 4, away: 0 } },
      // Grupo G
      { id: "m38", home: "Bélgica",        away: "Irã",             date: "21/06", time: "16h",    city: "Los Angeles",      group: "G", kickoff: "2026-06-21T16:00", result: { home: 0, away: 0 } },
      // Grupo H
      { id: "m39", home: "Uruguai",        away: "Cabo Verde",      date: "21/06", time: "19h",    city: "Miami",            group: "H", kickoff: "2026-06-21T19:00", result: null },
      // Grupo G
      { id: "m40", home: "Nova Zelândia",  away: "Egito",           date: "21/06", time: "22h",    city: "Vancouver",        group: "G", kickoff: "2026-06-21T22:00", result: null },
      // Grupo J
      { id: "m41", home: "Argentina",      away: "Áustria",         date: "22/06", time: "14h",    city: "Dallas",           group: "J", kickoff: "2026-06-22T14:00", result: null },
      // Grupo I
      { id: "m42", home: "França",         away: "Iraque",          date: "22/06", time: "18h",    city: "Filadélfia",       group: "I", kickoff: "2026-06-22T18:00", result: null },
      { id: "m43", home: "Noruega",        away: "Senegal",         date: "22/06", time: "21h",    city: "Nova York/NJ",     group: "I", kickoff: "2026-06-22T21:00", result: null },
      // Grupo J
      ...
      // Grupo L
      { id: "m46", home: "Inglaterra",     away: "Gana",            date: "23/06", time: "17h",    city: "Boston",           group: "L", kickoff: "2026-06-23T17:00", result: null },
      { id: "m47", home: "Panamá",         away: "Croácia",         date: "23/06", time: "20h",    city: "Toronto",          group: "L", kickoff: "2026-06-23T20:00", result: null },
      // Grupo K
      { id: "m48", home: "Colômbia",       away: "Congo (RD)",      date: "23/06", time: "23h",    city: "Guadalajara",      group: "K", kickoff: "2026-06-23T23:00", result: null },
    ],
  },
  {
    id: 3,
